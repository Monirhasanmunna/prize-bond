...
use App\Http\Services\Feature\Admin\DrawService;
...
class DrawController extends Controller
{
    ...
    public function getList(Request $request): Response|RedirectResponse
    {
        ...
        return $response['success'] ?
            Inertia::render('Admin/Draw/List/Page', $response)
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('Admin/Draw/Create/Page', $response);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return $response['success'] ?
            to_route('admin.draw.list')->with($response)
            : back()->withErrors($response['message']);
    }
